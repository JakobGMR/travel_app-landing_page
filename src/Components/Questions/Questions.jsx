...
const Questions = () => {
  const [active, setActive] = useState('How do I choose the right travel for me?');
  ...
  return (
    <div className='questions section container'>
      ...
      <div className="secContainer grid">
        {/* Will import a component from a different file */}
        <div className="accordion grid">
          <Accordion
            title='How do I choose the right travel for me?'
          ...
          <Accordion
            ...
            desc="Pack appropriate clothing, toiletries, travel documents (passport, visa,
              ...
              (e.g., hiking boots, snorkeiing gear)."
            active={active}
            setActive={setActive}
          />
        </div>
